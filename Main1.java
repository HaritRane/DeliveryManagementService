                ...
                case 1:
                    ...
                    do {
                        ...
                        switch (opt2) {
                            ...
                            case 2 -> opr.display_order();
                            case 3 -> opr.track_order();
                            case 4 -> {
...
//assign price according to size
            ...
            System.out.println("Enter 6 for HADAPSAR COLLECTION CENTRE");
            int c = sc.nextInt();
    ...
    void bubbleSort_time(details arr[]) {
        int n = arr.length;
...
// From the Array using extra space
    ...
    void display_path() {
        ...
        for (cms.details details : user) {
            for (int j = 0; j < arr.length; j++) {

                if (details.time == 8) {
                    arr[j] = details.weight;
                    int n = arr.length;
                    Arrays.sort(arr);
                   arr= op.removeDuplicates(arr, n);
       ...
       t.makepath(arr);
        for (int i=0;i<path1.length;i++) {
            int w= path1[i];
            switch (w) {
                case 0 -> System.out.println("Karvenagar");
                case 1 -> System.out.println("Warje");
                case 2 -> System.out.println("Deccan");
                case 3 -> System.out.println("Baner");
                case 4 -> System.out.println("Aundh");
                case 5 -> System.out.println("Hadapsar");
